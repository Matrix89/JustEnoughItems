...
public class IngredientListElement<V> implements IIngredientListElement<V> {
	...
	protected IngredientListElement(V ingredient, IIngredientHelper<V> ingredientHelper, IIngredientRenderer<V> ingredientRenderer) {
		...
		this.tooltipString = getTooltipString(ingredientRenderer, modId, modName, this.searchString);

		ColorNamer colorNamer = Internal.getColorNamer();
		if (Config.isColorSearchEnabled() && colorNamer != null) {
	...
	private static String getTooltipString(IIngredientRenderer<?> ingredientRenderer, String modId, String modName, String searchString) {
		List<String> tooltip;
		try {
			tooltip = ingredientRenderer.getTooltip(Minecraft.getMinecraft());

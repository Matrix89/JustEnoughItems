...
public class RecipeMap {
	...
	public void addRecipe(Object recipe, IRecipeCategory recipeCategory, Map<Class, Collection> ingredientsByType) {
		for (Map.Entry<Class, Collection> entry : ingredientsByType.entrySet()) {
			if (entry != null) {
	...
	private <V> void addRecipe(Object recipe, IRecipeCategory recipeCategory, Class<V> ingredientClass, Collection<V> ingredients) {
		...
		if (ingredientClass.equals(ItemStack.class)) {
			//noinspection unchecked
			ingredients = (Collection<V>) Internal.getStackHelper().getAllSubtypes(ingredients);
		}

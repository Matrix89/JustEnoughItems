...
public class Config {
	...
	public static void addItemToConfigBlacklist(ItemStack itemStack, IngredientBlacklistType blacklistType) {
	...
	public static void removeItemFromConfigBlacklist(ItemStack itemStack, IngredientBlacklistType blacklistType) {
		final String uid = getIngredientUid(itemStack, blacklistType);

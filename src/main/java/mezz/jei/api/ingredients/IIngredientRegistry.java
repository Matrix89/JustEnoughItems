...
public interface IIngredientRegistry {
	...
	/**
	 * Created an ingredient renderer for this ingredient.
	 */
	<V> IIngredientRenderer<V> getIngredientRenderer(V ingredient);

	/**
	 * Returns the appropriate ingredient renderer for this ingredient class
	 */
	<V> IIngredientRendererFactory<V> getIngredientRendererFactory(Class<V> ingredientClass);

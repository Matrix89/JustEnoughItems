...
public interface IIngredientHelper<V> {
	 ...
	 * Ingredients like FluidStack that have no wildcard ingredients should return the collection without editing it.
	 */
	Collection<V> expandSubtypes(Collection<V> ingredients);

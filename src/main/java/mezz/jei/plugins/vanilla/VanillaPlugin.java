...
public class VanillaPlugin extends BlankModPlugin {
	...
	public void registerIngredients(IModIngredientRegistration ingredientRegistration) {
		ingredientRegistration.register(ItemStack.class, ItemStackListFactory.create(), new ItemStackHelper(), new IIngredientRendererFactory<ItemStack>() {
			@Override
			public IIngredientRenderer<ItemStack> create(ItemStack ingredient) {
				return new ItemStackRenderer(ingredient);
			}
		});

		ingredientRegistration.register(FluidStack.class, FluidStackListFactory.create(), new FluidStackHelper(), new IIngredientRendererFactory<FluidStack>() {
			@Override
			public IIngredientRenderer<FluidStack> create(FluidStack ingredient) {
				return new FluidStackRenderer(ingredient);
			}
		});
	}

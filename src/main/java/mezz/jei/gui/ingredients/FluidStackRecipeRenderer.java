...
public class FluidStackRecipeRenderer implements IRecipeIngredientRenderer<FluidStack> {
	...
	public FluidStackRecipeRenderer(int capacityMb, boolean showCapacity, int width, int height, @Nullable IDrawable overlay) {
	...
	@Override
	public void onIngredientsSet(Collection<FluidStack> ingredients) {
